      ...
      <Container>
        <main className="space-y-6">
          ...
          <Prose className="mt-8">
            <h2>Features</h2>
            <ul>
              <li>✅ Production-ready headless WordPress architecture</li>
              <li>✅ Modern Next.js 16 App Router with TypeScript</li>
              <li>✅ Comprehensive SEO implementation (Open Graph, JSON-LD, XML Sitemap, RSS)</li>
              <li>✅ ISR with automatic cache invalidation via webhooks</li>
              <li>✅ Responsive design with Tailwind CSS and Craft Design System</li>
              <li>✅ Dockerized for local development and production deployment</li>
              <li>✅ Built-in CI/CD ready with GitHub Actions</li>
              <li>✅ Performance optimized with image optimization and server components</li>
              <li>✅ Full TypeScript support with WordPress API types</li>
